...
--
-- Host: localhost    Database: db_keep
-- ------------------------------------------------------
...
INSERT INTO `tb_class` VALUES (1,'初级','刘刘',50,5,100),(2,'中级','老四',40,3,50),(3,'高级','四哥',38,5,77),(4,'肚皮舞','张生',24,8,38),(5,'拉丁舞','老纪',20,7,55),(6,'瑜伽','赵本',13,7,78),(7,'搏击操','张草',16,9,87),(8,'爵士','朗诵',24,6,78),(9,'动感单车','不总',35,4,25),(10,'健美操','小高',10,3,34);
...
INSERT INTO `tb_material` VALUES (1,'跑步机',5,599,NULL,NULL),(2,'单杠',2,999,NULL,NULL),(3,'哑铃',10,24,NULL,NULL),(4,'美腰机',3,1888,NULL,NULL),(5,'台阶机',4,7500,NULL,NULL),(6,'跳绳',20,15,NULL,NULL),(7,'划船器',6,3400,NULL,NULL),(8,'坐姿推胸机',4,4446,NULL,NULL);
...
-- Dump completed on 2020-03-10 18:30:04
